...
/////////// Paste device specific setup here ///////////
...
void loop(){
 ...
 if ( millis() > t_start + t_wait) {
    ...
    // Paste sensor specific loop code here
      ...
      case '#':
        ...
        if (keypadCnt == 4) {
          ...
          for(int i=0; i<16;i++) {
            ...
            Serial.println((int) hashKey[i]);
          }
          Serial.println("Message:");
          for(int i=0;i<sizeof(longMessage);i++) {
            Serial.println((int) longMessage[i]);
          }
          pwFlag = 1;
