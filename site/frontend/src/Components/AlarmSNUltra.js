...
import ultraDiagram from "../Images/Fritzing/Images/NodeUS.png";
...
const AlarmSNUltra = () => {
  ...
  return (
    <div>
      ...
      <p>{t("guides.sn-ultra-intro")}
      </p>
      <p>
        {t("guides.tooltip-explain0")}
        <ToolDescription id="tooltip-snultra" name={t("tooltip.tooltipname")} description={t("tooltip.tooltipdesc")}/>
      ...
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          <Row>
            <Col>
              <img
                src={ultraDiagram}
                alt="Ultrasonic Sensor Node hookup diagram"
          ...
          <ul>
            ...
            <li>{t("guides.ultra-list1-sn")}</li>
            <li>{t("guides.ultra-list2-sn")}</li>
        ...
        <TabPane tabId="2">
          ...
          <p>
            ...
            <ToolDescription id="ide-snultra" name={t("tooltip.idename")} description={t("tooltip.idedesc")}/>
          ...
          <p>
            ...
            <ToolDescription id="lib-snultra" name={t("tooltip.libname")} description={t("tooltip.libdesc")}/>
